...
const AddProductModal = ({ isOpen, onClose, onProductAdded }) => {
  const [formData, setFormData] = useState({
    ...
    unidad_base: UNIDADES[0],
    perecedero: 1, // Default a True (1)
    requiere_frio: 0, // Default a False (0)
    permite_sublotes: 1, // Default a True (1)
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(`Producto "${formData.nombre}" creado con éxito!`);
      onProductAdded(); // Recargar la lista principal
      onClose();
    } catch (err) {
      const apiError =
    ...
    <div className="modal-overlay" onClick={handleOverlayClick}>
      <div className="modal-content">
        <div className="modal-header">
          <h3>
            <i className="fas fa-box-open"></i> Agregar Nuevo Producto
          </h3>
          <button
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <input
                ...
                placeholder="Ej: Limón, Azúcar, Frutilla"
                required
              />
            </div>
            <div className="form-group">
        ...
        <div className="modal-footer">
          ...
          >
            {isSubmitting ? (
              ...
              <>
                <i className="fas fa-check"></i> Crear Producto
              </>
            )}
          </button>
        </div>
