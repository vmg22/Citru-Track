...
import { Button, Table, Form, Row, Col, Card } from "react-bootstrap"; // Quitamos Badge de aquí, usaremos spans personalizados
...
const GestionPedidos = () => {
  ...
  const loadPedidos = async () => {
    setPedidos([
      {
        od_id: 1,
        od_code: "EXP-2023-08-001",
        cliente_nombre: "Importadora Europea S.A.",
        destino: "Rotterdam, Países Bajos",
        tipo_destino: "Marítimo",
        fecha_programada: "2023-08-25",
        cantidad_pallets_prevista: 24,
        estado: "en_ruta",
      },
      {
        od_id: 2,
        od_code: "EXP-2023-08-002",
        cliente_nombre: "Florida Fresh Inc.",
        destino: "Miami, EEUU",
        tipo_destino: "aéreo",
        fecha_programada: "2023-08-26",
        cantidad_pallets_prevista: 12,
        estado: "pendiente",
      },
      {
        od_id: 3,
        od_code: "OD-2023-09-001",
        cliente_nombre: "Distribuidora Local",
        destino: "Buenos Aires",
        tipo_destino: "terrestre",
        fecha_programada: "2023-09-01",
        cantidad_pallets_prevista: 33,
        estado: "entregado",
      },
    ]);
  };
  ...
  // --- FUNCIÓN ACTUALIZADA PARA BADGES ESTILIZADOS ---
  const badgeEstado = (estado) => {
    switch (estado) {
      ...
      default:
        return <span className="status-pill entregado">{estado}</span>;
    }
  };
  ...
  // --- TABLA ACTUALIZADA CON ESTILOS LIMPIOS ---
...
\
      ...
      {/* Contenedor de la tabla para dar bordes redondeados y sombra */}
            ...
            {pedidos.map((p) => (
              <tr key={p.od_id}>
                ...
                <td className="text-center">
                  <strong>{p.cantidad_pallets_prevista}</strong>
                </td>
  ...
  const DetallePedidoTab = () => (
    <Card className="p-5 mt-3 text-center shadow-sm" style={{ border: 'none', borderRadius: '12px' }}>
      ...
      <p className="text-muted mb-4">
        Vista detallada de la Orden de Despacho (logística, pallets asociados, historial).
      </p>
    ...
    <div className="gestion-pedidos-page">
      ...
      <div className="inline-filters-row">
        ...
        >
          ...
          <option value="Importadora Europea S.A.">
            Importadora Europea S.A.
          </option>
          <option value="Distribuciones Norte SA">
